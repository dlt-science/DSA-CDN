...
function update(source) {
  ...
  var nodeEnter = node.enter().append("svg:g")
    .attr("class", function(d) {
      ...
      else if (d.depth === 1) return "parent-node";
      else if (d.depth === 2) return "child-node";
      else if (d.depth === 3) return "sub-child-node";
      else return "grandchild-node";
    })
